...
const { PaymentService } = require('../apps/backend/dist/services/payment.service');
const { InventoryService } = require('../apps/backend/dist/services/inventory.service');
const { MenuService } = require('../apps/backend/dist/services/menu.service');
const { EmployeeService } = require('../apps/backend/dist/services/employee.service');
const { AnalyticsService } = require('../apps/backend/dist/services/analytics.service');
